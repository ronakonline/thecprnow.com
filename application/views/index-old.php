                        ...
                        <div class="pt-50 res-991-pt-0">
                            ...
                            <div class="section-title clearfix">
                                <div class="title-header">
                                    <h5>THE CPR NOW</h5>
                                    <h2 class="title">Get your Certificate Today</h2>
                                </div>
                            </div><!-- section title end -->
                            <div class="mb-30 clearfix">
                                <p>Need your CPR certification but hate to sit through another mind-numbing 6-hour class?  With THE CPR NOW! nationally-validated, fully-accredited online courses you can earn your Heartsaver/BLS, CPR, First Aid, AED, and Bloodborne Pathogens certification at your convenience and have your certificate today. </p>
                            </div>
                ...
                <div class="row">
                    <div class="col-lg-10 col-md-13">
                        ...
                        <div class="section-title with-desc clearfix">
                            <div class="title-header">
                                <h5>THE CPR NOW</h5>
                                <h3>A quick and completely risk-free. Ours is the only program that</h3>
                            </div>
                    ...
                    <div class="col-lg-12">
                        <div class="mt-10">
                            <div class="row">
                                <div class="col-md-6">
                                    <ul class="ttm-list ttm-list-style-icon ttm-list-icon-color-skincolor">
                                        <li><i class="fa fa-arrow-circle-right"></i><span class="ttm-list-li-content">Is nationally accredited; accepted in all 50 states, Canada, and worldwide</span></li>
                                        <li><i class="fa fa-arrow-circle-right"></i><span class="ttm-list-li-content">Is JCAHO, ILCOR, ECC, and OSHA 1910.1030(g)(2) compliant</span></li>
                                        <li><i class="fa fa-arrow-circle-right"></i><span class="ttm-list-li-content">Meets International Guidelines Conference on Cardiopulmonary Resuscitation standards</span></li>
                                        <li><i class="fa fa-arrow-circle-right"></i><span class="ttm-list-li-content">Includes most recent ARC and AHA/ILCOR Guidelines (October 15, 2015)</span></li>
                                        <li><i class="fa fa-arrow-circle-right"></i><span class="ttm-list-li-content"> Includes "compression-only" bystander-initiated CPR techniques (ILCOR 2008, 2010)</span></li>
                                        <li><i class="fa fa-arrow-circle-right"></i><span class="ttm-list-li-content">Does not require hands-on skills testing</span></li>
                                    </ul>
                                </div>
                                <div class="col-md-6">
                                    <ul class="ttm-list ttm-list-style-icon ttm-list-icon-color-skincolor">
                                        <li><i class="fa fa-arrow-circle-right"></i><span class="ttm-list-li-content">Includes instant 2-year certification from your own printer</span></li>
                                        <li><i class="fa fa-arrow-circle-right"></i><span class="ttm-list-li-content">Does not require additional fees for practical exam</span></li>
                                        <li><i class="fa fa-arrow-circle-right"></i><span class="ttm-list-li-content">Includes 60-day unlimited course access from any internet-connected device</span></li>
                                        <li><i class="fa fa-arrow-circle-right"></i><span class="ttm-list-li-content">Includes unlimited access to your certificate and wallet card</span></li>
                                        <li><i class="fa fa-arrow-circle-right"></i><span class="ttm-list-li-content">Is endorsed by CNN, & featured in USA Today, The New York Times</span></li>
                                        <li><i class="fa fa-arrow-circle-right"></i><span class="ttm-list-li-content">Is accepted in more places than any other online certification - GUARANTEED!</span></li>
                                    </ul>
                                </div>
