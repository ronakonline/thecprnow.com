                                        ...
                                        <div class="col-lg-4">
                                            <div class="page-header-breadcrumb">
                                                <ul class="breadcrumb-title">
                                                    ...
                                                    <li class="breadcrumb-item"><a href="#!">Manage Header</a>
                                                    </li>
                                        ...
                                        <div class="col-sm-12">
                                            ...
                                            <div class="card">
                                                ...
                                                <div class="card-block">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-sm-6">
                                                            <h4 class="sub-title">Manage Header</h4>
                                                            <form action="mheader/insert" method="post">

                                                                <div class="form-group row">
                                                                    <div class="col-sm-10">
                                                                        <?php if(isset($update)){ ?>
                                                                            <input type="text" name="updatename" class="form-control" value="<?php echo $name; ?>" required>
                                                                            <input type="text" value="<?php echo $update ?>" name="id" hidden>
                                                                        <?php } else{ ?>
                                              ...
                                              " data-original-title="Primary color states">Update</button>
                                                                        <?php }else{ ?>
                                                                        <button type="submit" class="btn btn-primary" id="primary-popover-content" data-container="body" data-toggle="popover" title="" data-placement="bottom" data-content="<div class='color-code'>
                                                            <div class='row'>
                                                              <div class='col-sm-6 col-xs-12'>
                                              ...
                                              " data-original-title="Primary color states">Add</button>
                                                                        <?php } ?>
                                                                    </div>
                                                                </div>
                                                            </form>
                                            ...
                                            <div class="card">
                                                <div class="card-header">
                                                    <h5>Header Items</h5>
                                                    <span>List of header items</span>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td style="white-space: nowrap; width: 1%;"><div class="tabledit-toolbar btn-toolbar" style="text-align: left;">
                                                                        <div class="btn-group btn-group-sm" style="float: none;">
                                                                            <a  href="mheader?update=<?php echo $row->id; ?>&name=<?php echo $row->name; ?>"><button type="button" class="tabledit-edit-button btn btn-primary waves-effect waves-light" style="float: none;margin: 5px;"><span class="icofont icofont-ui-edit"></span></button></a>
                                                                            <a href="mheader/insert?delete=<?php echo $row->id; ?>"><button type="button"  class="tabledit-delete-button btn btn-danger waves-effect waves-light" style="float: none;margin: 5px;"><span class="icofont icofont-ui-delete"></span></button></a>
                                                                        </div>
