                                        ...
                                        <div class="col-lg-4">
                                            <div class="page-header-breadcrumb">
                                                <ul class="breadcrumb-title">
                                                    ...
                                                    <li class="breadcrumb-item"><a href="#!">Add Lesson</a>
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-sm-12">
                                            <div class="card">
                                                ...
                                                <div class="card-block">
                                                    ...
                                                    <?php echo form_open_multipart('Mlessons/insert');?>
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-3">
                                                            <input type="text" name="title" class="form-control" placeholder="Lesson 1" required>
                                                        </div>
                                                    </div>
                                                    <div class="form-group row">
                                                        <label class="col-sm-2 col-form-label">About Lesson</label>
                                                        <div class="col-sm-10">
                                                            <textarea name="aboutlesson" rows="5" cols="5" class="form-control" required ></textarea>
                                                        </div>
                                                        <script>
